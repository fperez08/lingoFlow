...
export default function DeleteVideoModal({
  ...
  return (
    ...
    >
      <div
        className="bg-surface-container-lowest/90 backdrop-blur-[24px] rounded-xl shadow-2xl border border-outline-variant/20 w-full max-w-md p-8 transition-all duration-300"
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          ...
          <h2 className="font-headline text-2xl font-extrabold text-on-surface">Delete Video</h2>
        </div>
